...
DROP DATABASE IF EXISTS dict_db_01225_2;
DROP DATABASE IF EXISTS dict_db_01225_dictionary_2;
set allow_deprecated_database_ordinary=1;
-- Creation of a database with Ordinary engine emits a warning.
CREATE DATABASE dict_db_01225_2 ENGINE=Ordinary;    -- Different internal dictionary name with Atomic
