DROP DATABASE IF EXISTS db_01257;
CREATE DATABASE db_01257;

set check_table_dependencies=0;

CREATE TABLE db_01257.table1
(
    `col1` String,
    `col2` Int16,
    `col3` String,
...
SOURCE(CLICKHOUSE(HOST 'localhost' PORT tcpPort() DB db_01257 TABLE table1 USER 'default'))
LIFETIME(MIN 0 MAX 0) LAYOUT(COMPLEX_KEY_HASHED());

SELECT
    dictGet('db_01257.table1_dict', 'col6', (col1, col2, col3, col4, col5)),
    dictGet('db_01257.table1_dict', 'col7', (col1, col2, col3, col4, col5)),
    dictGet('db_01257.table1_dict', 'col8', (col1, col2, col3, col4, col5)),
    dictGet('db_01257.table1_dict', 'col9', (col1, col2, col3, col4, col5))
FROM db_01257.table1
WHERE dictHas('db_01257.table1_dict', (col1, col2, col3, col4, col5)); -- { serverError CANNOT_INSERT_NULL_IN_ORDINARY_COLUMN }

DROP TABLE db_01257.table1;
CREATE TABLE db_01257.table1
(
    `col1` String,
    `col2` Int16,
...
SELECT
    ...
    dictGet('db_01257.table1_dict', 'col9', (col1, col2, col3, col4, col5))
FROM db_01257.table1
WHERE dictHas('db_01257.table1_dict', (col1, col2, col3, col4, col5));
